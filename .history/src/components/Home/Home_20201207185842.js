      ...
      <div>
        {
          ...
          question == null
            ? null
            : Object.keys(question)question[key].optionOne.votes.some((key) => key !== authedUser) ||
            question[key].optionTwo.votes.some((key) => key !== authedUser).map((key) => (
  ...
  console.log(
    question == null
      ...
      : Object.keys(question).filter(
          (key) =>
            question[key].optionOne.votes.some((key) => key !== authedUser) ||
            question[key].optionTwo.votes.some((key) => key !== authedUser)
        )
  );
